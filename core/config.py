...
__author__ = "Hypsurus <hypsurus@mail.ru> Modified by JSacco"
__version__ = "1.0"
__codename__ = "Scratch"
...
url = sys.argv[1] or None
port = int(sys.argv[2]) or int(8080)
action_url = sys.argv[1] #sys.argv[4] or None
